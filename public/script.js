const pWale             = document.querySelector("#team-pst-wale"),
      pKola             = document.querySelector("#team-pst-kola"),
      setScores         = document.querySelector("#set-scores"),
      tableMP           = document.querySelector("#matches-played tbody"),
      tableStandings    = document.querySelector(".standings"),
      delBtn            = document.querySelectorAll(".red");
...
const addTeamPoints = (team1Score, team2Score) => {
...
const appendTableRow = (data) => {
    let sn = tableMP.querySelectorAll("tr"),
    ...
    let datePlayed = new Date(data.date),
...
const reduceTeamPoints = (team1Score, team2Score) => {
